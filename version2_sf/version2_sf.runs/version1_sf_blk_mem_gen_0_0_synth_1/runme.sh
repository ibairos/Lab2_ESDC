...
HD_PWD='/home/ibai/vivado/ESDC/Lab2/version1_sf/version1_sf.runs/version1_sf_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log version1_sf_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source version1_sf_blk_mem_gen_0_0.tcl
