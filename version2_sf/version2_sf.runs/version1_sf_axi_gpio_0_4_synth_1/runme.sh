...
HD_PWD='/home/ibai/vivado/ESDC/Lab2/version2_sf/version2_sf.runs/version1_sf_axi_gpio_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log version1_sf_axi_gpio_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source version1_sf_axi_gpio_0_4.tcl
