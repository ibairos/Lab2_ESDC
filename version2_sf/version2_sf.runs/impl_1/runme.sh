...
HD_PWD='/home/ibai/vivado/ESDC/Lab2/version2_sf/version2_sf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log version1_sf_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source version1_sf_wrapper.tcl -notrace
