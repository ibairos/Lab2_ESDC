...
HD_PWD='/home/ibai/vivado/ESDC/Lab2/version1_hw/version1_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log version1_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source version1_hw_wrapper.tcl -notrace
